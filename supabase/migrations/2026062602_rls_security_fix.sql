-- ============================================================================
-- 安全修复迁移：补全缺失的 RLS 策略（修复版）
-- Date: 2026-06-26
-- Priority: P0 (高危安全漏洞)
-- Issue: likes, user_impressions, moderation_logs 表无 RLS 保护
-- Note: addresses 表不存在（已移除相关策略）
-- ============================================================================
...
-- ============================================
-- 3. moderation_logs 表 RLS 策略（高危：审核日志无保护）
-- ============================================
...
-- ============================================
-- 4. 补充 posts/comments 表管理员 DELETE 策略
-- ============================================
...
WHERE schemaname = 'public'
  AND tablename IN ('likes', 'user_impressions', 'moderation_logs', 'posts', 'comments');
...
-- ============================================================================
-- 注意事项：
-- 1. addresses 表在远程数据库不存在，已移除相关策略
-- 2. 需要确保 current_user_is_admin() 函数已定义
