-- Fix: top_comments subquery referenced non-existent columns c.updated_at and c.like_count.
-- Restore original working logic: use c.created_at as updated_at, hardcode 0 for like_count.
