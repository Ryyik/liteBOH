-- Add following filter support: when p_following_user_ids is provided,
-- only return posts from those users.
...
comment on function public.list_forum_posts(integer, integer, text, uuid, boolean, text, text, uuid[]) is
  '论坛列表查询；返回点赞状态、最多 4 张预览图、最多 3 条顶级评论预览，支持标签、搜索、排序与关注筛选。';
